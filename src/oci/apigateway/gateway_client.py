...
class GatewayClient(object):
    ...
    def add_gateway_lock(self, gateway_id, add_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/apigateway/add_gateway_lock.py.html>`__ to see an example of how to use add_gateway_lock API.
        """
    ...
    def remove_gateway_lock(self, gateway_id, remove_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/apigateway/remove_gateway_lock.py.html>`__ to see an example of how to use remove_gateway_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['gatewayId']
