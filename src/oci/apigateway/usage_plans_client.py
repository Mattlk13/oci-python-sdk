...
class UsagePlansClient(object):
    ...
    def add_usage_plan_lock(self, usage_plan_id, add_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/apigateway/add_usage_plan_lock.py.html>`__ to see an example of how to use add_usage_plan_lock API.
        """
    ...
    def remove_usage_plan_lock(self, usage_plan_id, remove_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/apigateway/remove_usage_plan_lock.py.html>`__ to see an example of how to use remove_usage_plan_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['usagePlanId']
