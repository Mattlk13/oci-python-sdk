...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_TARGET_DATABASE_PRIVILEGE"
    OPERATION_TYPE_UPDATE_TARGET_DATABASE_PRIVILEGE = "UPDATE_TARGET_DATABASE_PRIVILEGE"
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_CRYPTO_ASSESSMENT"
    OPERATION_TYPE_UPDATE_CRYPTO_ASSESSMENT = "UPDATE_CRYPTO_ASSESSMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_CRYPTO_ASSESSMENT"
    OPERATION_TYPE_CREATE_CRYPTO_ASSESSMENT = "CREATE_CRYPTO_ASSESSMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "REFRESH_CRYPTO_ASSESSMENT"
    OPERATION_TYPE_REFRESH_CRYPTO_ASSESSMENT = "REFRESH_CRYPTO_ASSESSMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "GENERATE_CRYPTO_ASSESSMENT_REPORT"
    OPERATION_TYPE_GENERATE_CRYPTO_ASSESSMENT_REPORT = "GENERATE_CRYPTO_ASSESSMENT_REPORT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DOWNLOAD_CRYPTO_ASSESSMENT_REPORT"
    OPERATION_TYPE_DOWNLOAD_CRYPTO_ASSESSMENT_REPORT = "DOWNLOAD_CRYPTO_ASSESSMENT_REPORT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CHANGE_CRYPTO_ASSESSMENT_COMPARTMENT"
    OPERATION_TYPE_CHANGE_CRYPTO_ASSESSMENT_COMPARTMENT = "CHANGE_CRYPTO_ASSESSMENT_COMPARTMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_CRYPTO_ASSESSMENT"
    OPERATION_TYPE_DELETE_CRYPTO_ASSESSMENT = "DELETE_CRYPTO_ASSESSMENT"
