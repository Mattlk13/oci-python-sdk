...
class ServiceClient(object):
    ...
    def list_services(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/announcementsservice/list_services.py.html>`__ to see an example of how to use list_services API.
        """
