...
class WorkRequestManagementClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("work_request_management", config, signer, functions_type_mapping, **base_client_init_kwargs)
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/functions/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/functions/20260325/WorkRequest/CancelWorkRequest"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.functions.models.WorkRequest`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/functions/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/functions/20260325/WorkRequest/GetWorkRequest"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.functions.models.WorkRequestErrorCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/functions/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/functions/20260325/WorkRequestError/ListWorkRequestErrors"
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.functions.models.WorkRequestLogEntryCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/functions/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/functions/20260325/WorkRequestLogEntry/ListWorkRequestLogs"
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.functions.models.WorkRequestSummaryCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/functions/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/functions/20260325/WorkRequest/ListWorkRequests"
