...
class FunctionSourceDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.functions.models.ContainerImageFunctionSourceDetails`
        * :class:`~oci.functions.models.ArchiveFunctionSourceDetails`
        * :class:`~oci.functions.models.PreBuiltFunctionSourceDetails`
        ...
        :param source_type:
            ...
            Allowed values for this property are: "PRE_BUILT_FUNCTIONS", "ARCHIVE", "CONTAINER_IMAGE", 'UNKNOWN_ENUM_VALUE'.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'CONTAINER_IMAGE':
            return 'ContainerImageFunctionSourceDetails'

        if type == 'ARCHIVE':
            return 'ArchiveFunctionSourceDetails'
