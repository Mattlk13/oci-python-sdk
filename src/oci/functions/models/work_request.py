...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_FUNCTION"
    OPERATION_TYPE_CREATE_FUNCTION = "CREATE_FUNCTION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_FUNCTION"
    OPERATION_TYPE_UPDATE_FUNCTION = "UPDATE_FUNCTION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_FUNCTION"
    OPERATION_TYPE_DELETE_FUNCTION = "DELETE_FUNCTION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_APPLICATION"
    OPERATION_TYPE_CREATE_APPLICATION = "CREATE_APPLICATION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_APPLICATION"
    OPERATION_TYPE_UPDATE_APPLICATION = "UPDATE_APPLICATION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_APPLICATION"
    OPERATION_TYPE_DELETE_APPLICATION = "DELETE_APPLICATION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_FUNCTIONS_RUNTIME"
    OPERATION_TYPE_CREATE_FUNCTIONS_RUNTIME = "CREATE_FUNCTIONS_RUNTIME"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_FUNCTIONS_RUNTIME"
    OPERATION_TYPE_UPDATE_FUNCTIONS_RUNTIME = "UPDATE_FUNCTIONS_RUNTIME"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_FUNCTIONS_RUNTIME"
    OPERATION_TYPE_DELETE_FUNCTIONS_RUNTIME = "DELETE_FUNCTIONS_RUNTIME"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "ROLLBACK_FUNCTIONS_RUNTIME_VERSION"
    OPERATION_TYPE_ROLLBACK_FUNCTIONS_RUNTIME_VERSION = "ROLLBACK_FUNCTIONS_RUNTIME_VERSION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_FUNCTIONS_RUNTIME_VERSION"
    OPERATION_TYPE_CREATE_FUNCTIONS_RUNTIME_VERSION = "CREATE_FUNCTIONS_RUNTIME_VERSION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_FUNCTIONS_RUNTIME_VERSION"
    OPERATION_TYPE_UPDATE_FUNCTIONS_RUNTIME_VERSION = "UPDATE_FUNCTIONS_RUNTIME_VERSION"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_FUNCTION", "UPDATE_FUNCTION", "DELETE_FUNCTION", "CREATE_APPLICATION", "UPDATE_APPLICATION", "DELETE_APPLICATION", "CREATE_FUNCTIONS_RUNTIME", "UPDATE_FUNCTIONS_RUNTIME", "DELETE_FUNCTIONS_RUNTIME", "ROLLBACK_FUNCTIONS_RUNTIME_VERSION", "CREATE_FUNCTIONS_RUNTIME_VERSION", "UPDATE_FUNCTIONS_RUNTIME_VERSION", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.functions.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_FUNCTION", "UPDATE_FUNCTION", "DELETE_FUNCTION", "CREATE_APPLICATION", "UPDATE_APPLICATION", "DELETE_APPLICATION", "CREATE_FUNCTIONS_RUNTIME", "UPDATE_FUNCTIONS_RUNTIME", "DELETE_FUNCTIONS_RUNTIME", "ROLLBACK_FUNCTIONS_RUNTIME_VERSION", "CREATE_FUNCTIONS_RUNTIME_VERSION", "UPDATE_FUNCTIONS_RUNTIME_VERSION"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.functions.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.functions.models.WorkRequestResource]
        """
