...
class OmhubNetworkAnchorClient(object):
    ...
    def get_network_anchor(self, network_anchor_id, subscription_service_name, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/multicloud/get_network_anchor.py.html>`__ to see an example of how to use get_network_anchor API.
        """
