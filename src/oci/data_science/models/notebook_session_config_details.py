...
class NotebookSessionConfigDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param capacity_reservation_id:
            The value to assign to the capacity_reservation_id property of this NotebookSessionConfigDetails.
    ...
    def capacity_reservation_id(self):
        """
        Gets the capacity_reservation_id of this NotebookSessionConfigDetails.
        ...
        :return: The capacity_reservation_id of this NotebookSessionConfigDetails.
        :rtype: str
        """
    ...
    def capacity_reservation_id(self, capacity_reservation_id):
        """
        Sets the capacity_reservation_id of this NotebookSessionConfigDetails.
        This specifies the `OCID`__ of the customer-managed compute capacity reservation to be used for launching notebook sessions.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param capacity_reservation_id: The capacity_reservation_id of this NotebookSessionConfigDetails.
        :type: str
        """
