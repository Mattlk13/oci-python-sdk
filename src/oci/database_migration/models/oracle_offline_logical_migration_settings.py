...
class OracleOfflineLogicalMigrationSettings(OracleMigrationSettings):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OracleOfflineLogicalMigrationSettings object with values from keyword arguments. The default value of the :py:attr:`~oci.database_migration.models.OracleOfflineLogicalMigrationSettings.migration_method` attribute
        of this class is ``OFFLINE_LOGICAL`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param migration_method:
            The value to assign to the migration_method property of this OracleOfflineLogicalMigrationSettings.
        ...
        :param data_transfer_medium_details:
            The value to assign to the data_transfer_medium_details property of this OracleOfflineLogicalMigrationSettings.
        ...
        :param initial_load_settings:
            The value to assign to the initial_load_settings property of this OracleOfflineLogicalMigrationSettings.
        :type initial_load_settings: oci.database_migration.models.OracleInitialLoadSettings

        :param advisor_settings:
            The value to assign to the advisor_settings property of this OracleOfflineLogicalMigrationSettings.
        :type advisor_settings: oci.database_migration.models.OracleAdvisorSettings

        :param advanced_parameters:
            The value to assign to the advanced_parameters property of this OracleOfflineLogicalMigrationSettings.
    ...
    def data_transfer_medium_details(self):
        """
        Gets the data_transfer_medium_details of this OracleOfflineLogicalMigrationSettings.

        :return: The data_transfer_medium_details of this OracleOfflineLogicalMigrationSettings.
    ...
    def data_transfer_medium_details(self, data_transfer_medium_details):
        """
        Sets the data_transfer_medium_details of this OracleOfflineLogicalMigrationSettings.

        :param data_transfer_medium_details: The data_transfer_medium_details of this OracleOfflineLogicalMigrationSettings.
    ...
    def initial_load_settings(self):
        """
        Gets the initial_load_settings of this OracleOfflineLogicalMigrationSettings.

        :return: The initial_load_settings of this OracleOfflineLogicalMigrationSettings.
    ...
    def initial_load_settings(self, initial_load_settings):
        """
        Sets the initial_load_settings of this OracleOfflineLogicalMigrationSettings.

        :param initial_load_settings: The initial_load_settings of this OracleOfflineLogicalMigrationSettings.
    ...
    def advisor_settings(self):
        """
        Gets the advisor_settings of this OracleOfflineLogicalMigrationSettings.

        :return: The advisor_settings of this OracleOfflineLogicalMigrationSettings.
    ...
    def advisor_settings(self, advisor_settings):
        """
        Sets the advisor_settings of this OracleOfflineLogicalMigrationSettings.

        :param advisor_settings: The advisor_settings of this OracleOfflineLogicalMigrationSettings.
    ...
    def advanced_parameters(self):
        """
        Gets the advanced_parameters of this OracleOfflineLogicalMigrationSettings.
        List of Migration Parameter objects.


        :return: The advanced_parameters of this OracleOfflineLogicalMigrationSettings.
    ...
    def advanced_parameters(self, advanced_parameters):
        """
        Sets the advanced_parameters of this OracleOfflineLogicalMigrationSettings.
        List of Migration Parameter objects.


        :param advanced_parameters: The advanced_parameters of this OracleOfflineLogicalMigrationSettings.
