...
class AdministratorArtifactClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("administrator_artifact", config, signer, marketplace_publisher_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def update_admin_artifact_status(self, update_admin_artifact_status_details, artifact_id, **kwargs):
        """
        Updates the specified Artifact Status identified by the id.


        :param oci.marketplace_publisher.models.UpdateAdminArtifactStatusDetails update_admin_artifact_status_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/marketplacepublisher/update_admin_artifact_status.py.html>`__ to see an example of how to use update_admin_artifact_status API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['artifactId']
        resource_path = "/adminArtifacts/{artifactId}/status/new"
        method = "PUT"
        operation_name = "update_admin_artifact_status"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/publisher/20241201/AdminPublisher/UpdateAdminArtifactStatus"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_admin_artifact_status got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                body=update_admin_artifact_status_details,
