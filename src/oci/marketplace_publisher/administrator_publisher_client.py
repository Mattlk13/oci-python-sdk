...
class AdministratorPublisherClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("administrator_publisher", config, signer, marketplace_publisher_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def get_admin_publisher(self, publisher_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.marketplace_publisher.models.AdminPublisher`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/marketplacepublisher/get_admin_publisher.py.html>`__ to see an example of how to use get_admin_publisher API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['publisherId']
        resource_path = "/adminPublishers/{publisherId}"
        method = "GET"
        operation_name = "get_admin_publisher"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/publisher/20241201/AdminPublisher/GetAdminPublisher"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_admin_publisher got unknown kwargs: {extra_kwargs!r}")
