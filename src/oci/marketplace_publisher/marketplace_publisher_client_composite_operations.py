...
class MarketplacePublisherClientCompositeOperations(object):
    ...
    def delete_customer_instance_report_export_and_wait_for_state(self, customer_instance_report_export_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.marketplace_publisher.MarketplacePublisherClient.delete_customer_instance_report_export` and waits for the :py:class:`~oci.marketplace_publisher.models.CustomerInstanceReportExport` acted upon
        to enter the given state(s).
        ...
        :param list[str] wait_for_states:
            An array of states to wait on. These should be valid values for :py:attr:`~oci.marketplace_publisher.models.CustomerInstanceReportExport.lifecycle_state`

        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.marketplace_publisher.MarketplacePublisherClient.delete_customer_instance_report_export`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        initial_get_result = self.client.get_customer_instance_report_export(customer_instance_report_export_id)
        operation_result = None
        try:
            operation_result = self.client.delete_customer_instance_report_export(customer_instance_report_export_id, **operation_kwargs)
        except oci.exceptions.ServiceError as e:
            if e.status == 404:
                return WAIT_RESOURCE_NOT_FOUND
            else:
        ...
        try:
            if ("succeed_on_not_found" in waiter_kwargs) and (waiter_kwargs["succeed_on_not_found"] is False):
                self.client.base_client.logger.warning("The waiter kwarg succeed_on_not_found was passed as False for the delete composite operation delete_customer_instance_report_export, this would result in the operation to fail if the resource is not found! Please, do not pass this kwarg if this was not intended")
            else:
                """
    ...
    def generate_customer_instance_report_export_and_wait_for_state(self, generate_customer_instance_report_export_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.marketplace_publisher.MarketplacePublisherClient.generate_customer_instance_report_export` and waits for the :py:class:`~oci.marketplace_publisher.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.marketplace_publisher.MarketplacePublisherClient.generate_customer_instance_report_export`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.generate_customer_instance_report_export(generate_customer_instance_report_export_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def update_listing_revision_banner_content_and_wait_for_state(self, listing_revision_id, banner_name, update_listing_revision_banner_content, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.marketplace_publisher.MarketplacePublisherClient.update_listing_revision_banner_content` and waits for the :py:class:`~oci.marketplace_publisher.models.ListingRevision` acted upon
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.marketplace_publisher.MarketplacePublisherClient.update_listing_revision_banner_content`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.update_listing_revision_banner_content(listing_revision_id, banner_name, update_listing_revision_banner_content, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        listing_revision_id = operation_result.data.id
