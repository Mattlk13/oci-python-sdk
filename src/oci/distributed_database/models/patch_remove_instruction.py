...
class PatchRemoveInstruction(PatchInstruction):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PatchRemoveInstruction object with values from keyword arguments. The default value of the :py:attr:`~oci.distributed_database.models.PatchRemoveInstruction.operation` attribute
