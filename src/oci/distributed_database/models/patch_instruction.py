...
class PatchInstruction(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.distributed_database.models.PatchRemoveInstruction`
        * :class:`~oci.distributed_database.models.PatchInsertInstruction`
        * :class:`~oci.distributed_database.models.PatchMergeInstruction`
