...
class WorkRequestLogEntryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.distributed_database.models.WorkRequestLogEntry]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestLogEntryCollection.
        ...
        :rtype: list[oci.distributed_database.models.WorkRequestLogEntry]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.distributed_database.models.WorkRequestLogEntry]
        """
        self._items = items
