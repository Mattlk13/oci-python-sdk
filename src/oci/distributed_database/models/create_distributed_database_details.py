...
class CreateDistributedDatabaseDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type composite_raft_shard_spaces: list[oci.distributed_database.models.CreateCompositeRaftShardSpaceDetails]
        ...
        :type composite_data_guard_shard_spaces: list[oci.distributed_database.models.CreateCompositeDataGuardShardSpaceDetails]
        ...
        :type system_raft_clusters: list[oci.distributed_database.models.CreateSystemRaftClusterDetails]
        ...
        :type system_data_guard_databases: oci.distributed_database.models.CreateSystemDataGuardDatabaseDetails

        :param user_shard_spaces:
            The value to assign to the user_shard_spaces property of this CreateDistributedDatabaseDetails.
        :type user_shard_spaces: list[oci.distributed_database.models.CreateUserShardSpaceDetails]
        ...
        self._redacted_field_paths = [
            ['composite_raft_shard_spaces', '*', 'raft_clusters', '*', 'databases', '*', 'tde_wallet_password'],
            ['composite_data_guard_shard_spaces', '*', 'original_replica', 'databases', '*', 'tde_wallet_password'],
            ['composite_data_guard_shard_spaces', '*', 'data_guard_replicas', '*', 'databases', '*', 'tde_wallet_password'],
            ['system_raft_clusters', '*', 'databases', '*', 'tde_wallet_password'],
            ['system_data_guard_databases', 'original_replica', 'databases', '*', 'tde_wallet_password'],
            ['system_data_guard_databases', 'data_guard_replicas', '*', 'databases', '*', 'tde_wallet_password'],
            ['user_shard_spaces', '*', 'original_replica', 'database', 'tde_wallet_password'],
            ['user_shard_spaces', '*', 'data_guard_replicas', '*', 'database', 'tde_wallet_password'],
            ['catalog_details', '*', 'original_replica', 'database', 'tde_wallet_password'],
            ['catalog_details', '*', 'data_guard_replicas', '*', 'database', 'tde_wallet_password'],
        ]
    ...
    def composite_raft_shard_spaces(self):
        ...
        :rtype: list[oci.distributed_database.models.CreateCompositeRaftShardSpaceDetails]
        """
    ...
    def composite_raft_shard_spaces(self, composite_raft_shard_spaces):
        ...
        :type: list[oci.distributed_database.models.CreateCompositeRaftShardSpaceDetails]
        """
    ...
    def composite_data_guard_shard_spaces(self):
        ...
        :rtype: list[oci.distributed_database.models.CreateCompositeDataGuardShardSpaceDetails]
        """
    ...
    def composite_data_guard_shard_spaces(self, composite_data_guard_shard_spaces):
        ...
        :type: list[oci.distributed_database.models.CreateCompositeDataGuardShardSpaceDetails]
        """
    ...
    def system_raft_clusters(self):
        ...
        :rtype: list[oci.distributed_database.models.CreateSystemRaftClusterDetails]
        """
    ...
    def system_raft_clusters(self, system_raft_clusters):
        ...
        :type: list[oci.distributed_database.models.CreateSystemRaftClusterDetails]
        """
    ...
    def system_data_guard_databases(self):
        ...
        :rtype: oci.distributed_database.models.CreateSystemDataGuardDatabaseDetails
        """
    ...
    def system_data_guard_databases(self, system_data_guard_databases):
        ...
        :type: oci.distributed_database.models.CreateSystemDataGuardDatabaseDetails
        """
    ...
    def user_shard_spaces(self):
        ...
        :rtype: list[oci.distributed_database.models.CreateUserShardSpaceDetails]
        """
    ...
    def user_shard_spaces(self, user_shard_spaces):
        ...
        :type: list[oci.distributed_database.models.CreateUserShardSpaceDetails]
        """
    ...
    def __repr__(self):
        ...
        redact_password_field(as_dict, ['composite_raft_shard_spaces', '*', 'raft_clusters', '*', 'databases', '*', 'tde_wallet_password'])
        redact_password_field(as_dict, ['composite_data_guard_shard_spaces', '*', 'original_replica', 'databases', '*', 'tde_wallet_password'])
        redact_password_field(as_dict, ['composite_data_guard_shard_spaces', '*', 'data_guard_replicas', '*', 'databases', '*', 'tde_wallet_password'])
        redact_password_field(as_dict, ['system_raft_clusters', '*', 'databases', '*', 'tde_wallet_password'])
        redact_password_field(as_dict, ['system_data_guard_databases', 'original_replica', 'databases', '*', 'tde_wallet_password'])
        redact_password_field(as_dict, ['system_data_guard_databases', 'data_guard_replicas', '*', 'databases', '*', 'tde_wallet_password'])
        redact_password_field(as_dict, ['user_shard_spaces', '*', 'original_replica', 'database', 'tde_wallet_password'])
        redact_password_field(as_dict, ['user_shard_spaces', '*', 'data_guard_replicas', '*', 'database', 'tde_wallet_password'])
        redact_password_field(as_dict, ['catalog_details', '*', 'original_replica', 'database', 'tde_wallet_password'])
        redact_password_field(as_dict, ['catalog_details', '*', 'data_guard_replicas', '*', 'database', 'tde_wallet_password'])
