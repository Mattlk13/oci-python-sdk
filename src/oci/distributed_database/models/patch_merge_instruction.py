...
class PatchMergeInstruction(PatchInstruction):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PatchMergeInstruction object with values from keyword arguments. The default value of the :py:attr:`~oci.distributed_database.models.PatchMergeInstruction.operation` attribute
