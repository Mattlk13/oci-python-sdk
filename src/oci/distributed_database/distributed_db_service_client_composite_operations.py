...
class DistributedDbServiceClientCompositeOperations(object):
    ...
    def scale_distributed_database_gsms_and_wait_for_state(self, scale_distributed_database_gsms_details, distributed_database_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.distributed_database.DistributedDbServiceClient.scale_distributed_database_gsms` and waits for the :py:class:`~oci.distributed_database.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.distributed_database.DistributedDbServiceClient.scale_distributed_database_gsms`
