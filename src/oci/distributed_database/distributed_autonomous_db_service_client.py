...
class DistributedAutonomousDbServiceClient(object):
    ...
    def add_distributed_autonomous_database_gds_control_node(self, distributed_autonomous_database_id, add_distributed_autonomous_database_gds_control_node_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/add_distributed_autonomous_database_gds_control_node.py.html>`__ to see an example of how to use add_distributed_autonomous_database_gds_control_node API.
        """
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/AddDistributedAutonomousDatabaseGdsControlNode"
    ...
    def change_distributed_autonomous_database_compartment(self, change_distributed_autonomous_database_compartment_details, distributed_autonomous_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/change_distributed_autonomous_database_compartment.py.html>`__ to see an example of how to use change_distributed_autonomous_database_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ChangeDistributedAutonomousDatabaseCompartment"
    ...
    def change_distributed_autonomous_db_backup_config(self, distributed_autonomous_database_id, change_distributed_autonomous_db_backup_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/change_distributed_autonomous_db_backup_config.py.html>`__ to see an example of how to use change_distributed_autonomous_db_backup_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ChangeDistributedAutonomousDbBackupConfig"
    ...
    def configure_distributed_autonomous_database_auto_resource_management(self, distributed_autonomous_database_id, configure_distributed_autonomous_database_auto_resource_management_details, **kwargs):
        """
        ...
        :param oci.distributed_database.models.ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails configure_distributed_autonomous_database_auto_resource_management_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database.models.DistributedAutonomousDatabaseAutoResourceManagementDetails`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/configure_distributed_autonomous_database_auto_resource_management.py.html>`__ to see an example of how to use configure_distributed_autonomous_database_auto_resource_management API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/configureAutoResourceManagement"
        method = "POST"
        operation_name = "configure_distributed_autonomous_database_auto_resource_management"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ConfigureDistributedAutonomousDatabaseAutoResourceManagement"
        ...
        if extra_kwargs:
            raise ValueError(
                f"configure_distributed_autonomous_database_auto_resource_management got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=configure_distributed_autonomous_database_auto_resource_management_details,
                response_type="DistributedAutonomousDatabaseAutoResourceManagementDetails",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def configure_distributed_autonomous_database_gsm_wallet(self, configure_distributed_autonomous_database_gsm_wallet_details, distributed_autonomous_database_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/configure_distributed_autonomous_database_gsm_wallet.py.html>`__ to see an example of how to use configure_distributed_autonomous_database_gsm_wallet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/configureGsmWallet"
        method = "POST"
        operation_name = "configure_distributed_autonomous_database_gsm_wallet"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ConfigureDistributedAutonomousDatabaseGsmWallet"
        ...
        if extra_kwargs:
            raise ValueError(
                f"configure_distributed_autonomous_database_gsm_wallet got unknown kwargs: {extra_kwargs!r}")
    ...
    def configure_distributed_autonomous_database_gsms(self, configure_distributed_autonomous_database_gsms_details, distributed_autonomous_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/configure_distributed_autonomous_database_gsms.py.html>`__ to see an example of how to use configure_distributed_autonomous_database_gsms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ConfigureDistributedAutonomousDatabaseGsms"
    ...
    def configure_distributed_autonomous_database_sharding(self, distributed_autonomous_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/configure_distributed_autonomous_database_sharding.py.html>`__ to see an example of how to use configure_distributed_autonomous_database_sharding API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ConfigureDistributedAutonomousDatabaseSharding"
    ...
    def create_distributed_autonomous_database(self, create_distributed_autonomous_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/create_distributed_autonomous_database.py.html>`__ to see an example of how to use create_distributed_autonomous_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_distributed_autonomous_database(self, distributed_autonomous_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/delete_distributed_autonomous_database.py.html>`__ to see an example of how to use delete_distributed_autonomous_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/DeleteDistributedAutonomousDatabase"
    ...
    def generate_distributed_autonomous_database_wallet(self, distributed_autonomous_database_id, generate_distributed_autonomous_database_wallet_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/generate_distributed_autonomous_database_wallet.py.html>`__ to see an example of how to use generate_distributed_autonomous_database_wallet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/GenerateDistributedAutonomousDatabaseWallet"
    ...
    def get_distributed_autonomous_database(self, distributed_autonomous_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/get_distributed_autonomous_database.py.html>`__ to see an example of how to use get_distributed_autonomous_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}"
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/GetDistributedAutonomousDatabase"
    ...
    def get_distributed_autonomous_database_raft_metric(self, distributed_autonomous_database_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database.models.DistributedAutonomousDatabaseRaftMetric`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/get_distributed_autonomous_database_raft_metric.py.html>`__ to see an example of how to use get_distributed_autonomous_database_raft_metric API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/raftMetrics"
        method = "GET"
        operation_name = "get_distributed_autonomous_database_raft_metric"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/GetDistributedAutonomousDatabaseRaftMetric"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_distributed_autonomous_database_raft_metric got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                response_type="DistributedAutonomousDatabaseRaftMetric",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def get_distributed_autonomous_database_ru_change_log(self, distributed_autonomous_database_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database.models.DistributedAutonomousDatabaseRuChangeLog`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/get_distributed_autonomous_database_ru_change_log.py.html>`__ to see an example of how to use get_distributed_autonomous_database_ru_change_log API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/ruChangeLog"
        method = "GET"
        operation_name = "get_distributed_autonomous_database_ru_change_log"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/GetDistributedAutonomousDatabaseRuChangeLog"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_distributed_autonomous_database_ru_change_log got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="DistributedAutonomousDatabaseRuChangeLog",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def list_distributed_autonomous_databases(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/list_distributed_autonomous_databases.py.html>`__ to see an example of how to use list_distributed_autonomous_databases API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabaseCollection/ListDistributedAutonomousDatabases"
    ...
    def move_distributed_autonomous_database_replication_unit(self, distributed_autonomous_database_id, move_distributed_autonomous_database_replication_unit_details, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/move_distributed_autonomous_database_replication_unit.py.html>`__ to see an example of how to use move_distributed_autonomous_database_replication_unit API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/moveReplicationUnit"
        method = "POST"
        operation_name = "move_distributed_autonomous_database_replication_unit"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/MoveDistributedAutonomousDatabaseReplicationUnit"
        ...
        if extra_kwargs:
            raise ValueError(
                f"move_distributed_autonomous_database_replication_unit got unknown kwargs: {extra_kwargs!r}")
    ...
    def patch_distributed_autonomous_database(self, distributed_autonomous_database_id, patch_distributed_autonomous_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/patch_distributed_autonomous_database.py.html>`__ to see an example of how to use patch_distributed_autonomous_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}"
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/PatchDistributedAutonomousDatabase"
    ...
    def recreate_failed_distributed_autonomous_database_resource(self, distributed_autonomous_database_id, resource_name, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/recreate_failed_distributed_autonomous_database_resource.py.html>`__ to see an example of how to use recreate_failed_distributed_autonomous_database_resource API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId', 'resourceName']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/recreateFailedResource"
        method = "POST"
        operation_name = "recreate_failed_distributed_autonomous_database_resource"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/RecreateFailedDistributedAutonomousDatabaseResource"
        ...
        if extra_kwargs:
            raise ValueError(
                f"recreate_failed_distributed_autonomous_database_resource got unknown kwargs: {extra_kwargs!r}")
    ...
    def rotate_distributed_autonomous_database_passwords(self, distributed_autonomous_database_id, rotate_distributed_autonomous_database_passwords_details, **kwargs):
        """
        ...
        :param oci.distributed_database.models.RotateDistributedAutonomousDatabasePasswordsDetails rotate_distributed_autonomous_database_passwords_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/rotate_distributed_autonomous_database_passwords.py.html>`__ to see an example of how to use rotate_distributed_autonomous_database_passwords API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/RotateDistributedAutonomousDatabasePasswords"
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=rotate_distributed_autonomous_database_passwords_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def scale_distributed_autonomous_database_gsms(self, scale_distributed_autonomous_database_gsms_details, distributed_autonomous_database_id, **kwargs):
        """
        Scale global service manager(GSM aka shard director) instances for the Globally distributed autonomous database.


        :param oci.distributed_database.models.ScaleDistributedAutonomousDatabaseGsmsDetails scale_distributed_autonomous_database_gsms_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/scale_distributed_autonomous_database_gsms.py.html>`__ to see an example of how to use scale_distributed_autonomous_database_gsms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/scaleGsms"
        method = "POST"
        operation_name = "scale_distributed_autonomous_database_gsms"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ScaleDistributedAutonomousDatabaseGsms"
        ...
        if extra_kwargs:
            raise ValueError(
                f"scale_distributed_autonomous_database_gsms got unknown kwargs: {extra_kwargs!r}")
    ...
    def start_distributed_autonomous_database(self, distributed_autonomous_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/start_distributed_autonomous_database.py.html>`__ to see an example of how to use start_distributed_autonomous_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/StartDistributedAutonomousDatabase"
    ...
    def stop_distributed_autonomous_database(self, distributed_autonomous_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/stop_distributed_autonomous_database.py.html>`__ to see an example of how to use stop_distributed_autonomous_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/StopDistributedAutonomousDatabase"
    ...
    def update_distributed_autonomous_database(self, distributed_autonomous_database_id, update_distributed_autonomous_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/update_distributed_autonomous_database.py.html>`__ to see an example of how to use update_distributed_autonomous_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}"
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/UpdateDistributedAutonomousDatabase"
    ...
    def validate_distributed_autonomous_database_ca_bundle(self, distributed_autonomous_database_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/validate_distributed_autonomous_database_ca_bundle.py.html>`__ to see an example of how to use validate_distributed_autonomous_database_ca_bundle API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        resource_path = "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/validateCaBundle"
        method = "POST"
        operation_name = "validate_distributed_autonomous_database_ca_bundle"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ValidateDistributedAutonomousDatabaseCaBundle"
        ...
        if extra_kwargs:
            raise ValueError(
                f"validate_distributed_autonomous_database_ca_bundle got unknown kwargs: {extra_kwargs!r}")
    ...
    def validate_distributed_autonomous_database_network(self, distributed_autonomous_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/validate_distributed_autonomous_database_network.py.html>`__ to see an example of how to use validate_distributed_autonomous_database_network API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedAutonomousDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ValidateDistributedAutonomousDatabaseNetwork"
