...
class DistributedDbPrivateEndpointServiceClient(object):
    ...
    def change_distributed_database_private_endpoint_compartment(self, change_distributed_database_private_endpoint_compartment_details, distributed_database_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/change_distributed_database_private_endpoint_compartment.py.html>`__ to see an example of how to use change_distributed_database_private_endpoint_compartment API.
        """
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabasePrivateEndpoint/ChangeDistributedDatabasePrivateEndpointCompartment"
    ...
    def create_distributed_database_private_endpoint(self, create_distributed_database_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/create_distributed_database_private_endpoint.py.html>`__ to see an example of how to use create_distributed_database_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_distributed_database_private_endpoint(self, distributed_database_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/delete_distributed_database_private_endpoint.py.html>`__ to see an example of how to use delete_distributed_database_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabasePrivateEndpointId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabasePrivateEndpoint/DeleteDistributedDatabasePrivateEndpoint"
    ...
    def get_distributed_database_private_endpoint(self, distributed_database_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/get_distributed_database_private_endpoint.py.html>`__ to see an example of how to use get_distributed_database_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabasePrivateEndpointId']
        resource_path = "/distributedDatabasePrivateEndpoints/{distributedDatabasePrivateEndpointId}"
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabasePrivateEndpoint/GetDistributedDatabasePrivateEndpoint"
    ...
    def list_distributed_database_private_endpoints(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/list_distributed_database_private_endpoints.py.html>`__ to see an example of how to use list_distributed_database_private_endpoints API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabasePrivateEndpointCollection/ListDistributedDatabasePrivateEndpoints"
    ...
    def patch_distributed_database_private_endpoint(self, distributed_database_private_endpoint_id, patch_distributed_database_private_endpoint_details, **kwargs):
        """
        ...
        :param oci.distributed_database.models.PatchDistributedDatabasePrivateEndpointDetails patch_distributed_database_private_endpoint_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/patch_distributed_database_private_endpoint.py.html>`__ to see an example of how to use patch_distributed_database_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabasePrivateEndpointId']
        resource_path = "/distributedDatabasePrivateEndpoints/{distributedDatabasePrivateEndpointId}"
        method = "PATCH"
        operation_name = "patch_distributed_database_private_endpoint"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabasePrivateEndpoint/PatchDistributedDatabasePrivateEndpoint"
        ...
        if extra_kwargs:
            raise ValueError(
                f"patch_distributed_database_private_endpoint got unknown kwargs: {extra_kwargs!r}")
    ...
    def reinstate_proxy_instance(self, distributed_database_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/reinstate_proxy_instance.py.html>`__ to see an example of how to use reinstate_proxy_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabasePrivateEndpointId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabasePrivateEndpoint/ReinstateProxyInstance"
    ...
    def update_distributed_database_private_endpoint(self, distributed_database_private_endpoint_id, update_distributed_database_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/update_distributed_database_private_endpoint.py.html>`__ to see an example of how to use update_distributed_database_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabasePrivateEndpointId']
        resource_path = "/distributedDatabasePrivateEndpoints/{distributedDatabasePrivateEndpointId}"
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabasePrivateEndpoint/UpdateDistributedDatabasePrivateEndpoint"
