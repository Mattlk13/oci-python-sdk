...
class DistributedDbServiceClient(object):
    ...
    def configure_distributed_database_auto_resource_management(self, distributed_database_id, configure_distributed_database_auto_resource_management_details, **kwargs):
        ...
        :param oci.distributed_database.models.ConfigureDistributedDatabaseAutoResourceManagementDetails configure_distributed_database_auto_resource_management_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database.models.DistributedDatabaseAutoResourceManagementDetails`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/configure_distributed_database_auto_resource_management.py.html>`__ to see an example of how to use configure_distributed_database_auto_resource_management API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def get_distributed_database_ru_change_log(self, distributed_database_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database.models.DistributedDatabaseRuChangeLog`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/get_distributed_database_ru_change_log.py.html>`__ to see an example of how to use get_distributed_database_ru_change_log API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def rotate_distributed_database_passwords(self, distributed_database_id, rotate_distributed_database_passwords_details, **kwargs):
        ...
        :param oci.distributed_database.models.RotateDistributedDatabasePasswordsDetails rotate_distributed_database_passwords_details: (required)
    ...
    def scale_distributed_database_gsms(self, scale_distributed_database_gsms_details, distributed_database_id, **kwargs):
        ...
        :param oci.distributed_database.models.ScaleDistributedDatabaseGsmsDetails scale_distributed_database_gsms_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabase/scale_distributed_database_gsms.py.html>`__ to see an example of how to use scale_distributed_database_gsms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
