...
class TenancyAttachmentClient(object):
    ...
    def create_tenancy_attachment(self, create_tenancy_attachment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/resourceanalytics/create_tenancy_attachment.py.html>`__ to see an example of how to use create_tenancy_attachment API.
        """
    ...
    def delete_tenancy_attachment(self, tenancy_attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/resourceanalytics/delete_tenancy_attachment.py.html>`__ to see an example of how to use delete_tenancy_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_tenancy_attachment(self, tenancy_attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/resourceanalytics/get_tenancy_attachment.py.html>`__ to see an example of how to use get_tenancy_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['tenancyAttachmentId']
        resource_path = "/tenancyAttachments/{tenancyAttachmentId}"
    ...
    def list_tenancy_attachments(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/resourceanalytics/list_tenancy_attachments.py.html>`__ to see an example of how to use list_tenancy_attachments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/tenancyAttachments"
    ...
    def update_tenancy_attachment(self, tenancy_attachment_id, update_tenancy_attachment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/resourceanalytics/update_tenancy_attachment.py.html>`__ to see an example of how to use update_tenancy_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['tenancyAttachmentId']
        resource_path = "/tenancyAttachments/{tenancyAttachmentId}"
