...
class EsxiHostClient(object):
    ...
    def inplace_upgrade(self, esxi_host_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/ocvp/inplace_upgrade.py.html>`__ to see an example of how to use inplace_upgrade API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['esxiHostId']
    ...
    def replace_host(self, esxi_host_id, replace_host_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/ocvp/replace_host.py.html>`__ to see an example of how to use replace_host API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['esxiHostId']
    ...
    def swap_billing(self, esxi_host_id, swap_billing_host_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/ocvp/swap_billing.py.html>`__ to see an example of how to use swap_billing API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
